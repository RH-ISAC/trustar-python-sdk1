...
class TruStar(object):
    ...
    def get_token(self, verify=None):
        """
    ...
    def request(self, method, path, headers=None, raise_for_status=True, verify=None, **kwargs):
        """
    ...
    def get_reports(self, from_time=None, to_time=None, distribution_type=None, submitted_by=None,
        ...
        resp = self.get("reports", params=params, **kwargs)
    ...
    def get_report_details(self, report_id, id_type=None, **kwargs):
        ...
        resp = self.get("report/%s" % report_id, params=params, **kwargs)
        return json.loads(resp.content.decode('utf8'))
    ...
    def update_report(self, report_id, id_type=None, title=None, report_body=None, time_began=None,
        ...
        resp = self.put("report/%s" % report_id, data=json.dumps(payload), params=params, **kwargs)
    ...
    def delete_report(self, report_id, id_type=None, **kwargs):
        ...
        """
        params = {'idType': id_type}
        resp = self.delete("report/%s" % report_id, params=params, **kwargs)
        return resp
    ...
    def query_latest_indicators(self, source, indicator_types, limit, interval_size, **kwargs):
        ...
        resp = self.get("indicators/latest", params=payload, **kwargs)
        return json.loads(resp.content.decode('utf8'))
    ...
    def get_community_trends(self, type, from_time, to_time, page_size, start_page, **kwargs):
        ...
        resp = self.get("community-indicators/trending", params=payload, **kwargs)
        return json.loads(resp.content.decode('utf8'))

    def get_correlated_reports(self, indicator, **kwargs):
        """
        ...
        """
        payload = {'q': indicator}
        resp = self.get("reports/correlate", params=payload, **kwargs)
        return json.loads(resp.content.decode('utf8'))
    ...
    def query_indicators(self, indicators, limit, **kwargs):
        ...
        resp = self.get("indicators", params=payload, **kwargs)
        return json.loads(resp.content.decode('utf8'))
    ...
    def submit_report(self, report_body, title, external_id=None, external_url=None, time_began=datetime.now(),
        ...
        resp = self.post("report", data=json.dumps(payload), timeout=60, **kwargs)
        return resp.json()
    ...
    def get_enclave_tags(self, report_id, id_type=None, **kwargs):
        ...
        """
        params = {'idType': id_type}
        resp = self.get("reports/%s/enclave-tags" % report_id, params=params, **kwargs)
        return json.loads(resp.content.decode('utf8'))
    ...
    def add_enclave_tag(self, report_id, name, enclave_id, id_type=None, **kwargs):
        ...
        resp = self.post("reports/%s/enclave-tags" % report_id, params=params, **kwargs)
        return json.loads(resp.content.decode('utf8'))
    ...
    def delete_enclave_tag(self, report_id, name, enclave_id, id_type=None, **kwargs):
        ...
        """
        params = {'idType': id_type, 'name': name, 'enclaveId': enclave_id}
        resp = self.delete("reports/%s/enclave-tags" % report_id, params=params, **kwargs)
